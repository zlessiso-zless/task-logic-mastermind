  ...
  return (
    <footer className="bg-glam-dark text-white py-12 px-6 sm:px-10 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-sm text-white/50 flex flex-col md:flex-row justify-between">
          <p>&copy; {new Date().getFullYear()} GlamSteals. All rights reserved.</p>
