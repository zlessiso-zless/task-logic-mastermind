    ...
    <footer className="bg-glam-dark text-white py-12 px-6 sm:px-10 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-white/70 hover:text-white text-sm transition-colors">How It Works</a></li>
                <li><a href="#" className="text-white/70 hover:text-white text-sm transition-colors">Point System</a></li>
                <li><a href="#" className="text-white/70 hover:text-white text-sm transition-colors">Tiers & Benefits</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-white/70 hover:text-white text-sm transition-colors">Shipping Policy</a></li>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="flex">
                    <input
                      ...
                      className="px-3 py-2 text-sm bg-glam-dark border border-white/20 rounded-l-md text-white w-full focus:outline-none focus:border-white"
                      required
                    />
                    <button
                      type="submit"
                      className="bg-white px-3 py-2 text-glam-dark text-sm rounded-r-md hover:bg-white/90"
                    >
                      Join
                    </button>
                  </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm text-white/60">
          <p>© {new Date().getFullYear()} GlamSteals. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
